...
import { ConfigComponente }     from './partidos.config';
...
export class PartidosComponent extends PageGenerica2<Partidos<PartidoInterface> > implements OnInit, OnDestroy {
