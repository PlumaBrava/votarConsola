...
export class ConfigListadoCache_Usuarios {
   ...
   constructor(public argumentos:any) {
    ...
    console.log('Aimportadores ConfigListadoCache_AuxVehiculos',argumentos);
      ...
      this.configListadosCache.push({ 
        nombreListado                 : 'listadoPerfiles',
        nombreColeccion               : 'Perfiles',
        orderBy                       : [{key:'key',ascDesc:'asc'}],
        grabaLocalStorage             : true,
        organizacionKNAI              : argumentos.organizacionKNAI,
        nombreColeccionSolicitante    : 'Soliciud de Perfiles transf Excel Ubicaciones', //se usa en el log.
      });

      this.configListadosCache.push({ 
        nombreListado                 : 'listadoDistribuidor',
        nombreColeccion               : 'Distribuidor',
        orderBy                       : [{key:'key',ascDesc:'asc'}],
        grabaLocalStorage             : true,
        organizacionKNAI              : argumentos.organizacionKNAI,
        nombreColeccionSolicitante    : 'Soliciud de Distribuidor transf Excel Ubicaciones', //se usa en el log.
      });
      ...
      this.configListadosCache.push({ 
        ...
        grabaLocalStorage             : true,
        organizacionKNAI              : argumentos.organizacionKNAI,
        nombreColeccionSolicitante    : 'Soliciud de Sucursales transf Excel Ubicaciones', //se usa en el log.
      });
      ...
      this.configListadosCache.push({ 
        ...
        grabaLocalStorage             : true,
        organizacionKNAI              : argumentos.organizacionKNAI,
        nombreColeccionSolicitante    : 'Soliciud de AreasNegocio transf Excel Ubicaciones', //se usa en el log.
      });
